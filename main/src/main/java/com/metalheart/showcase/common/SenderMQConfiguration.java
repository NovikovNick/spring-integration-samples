...
@Configuration
public class SenderMQConfiguration {
    ...
    public Binding senderBinding(@Qualifier(QUEUE_NAME) Queue queue,
    ...
    public RabbitTemplate senderTemplate(ConnectionFactory connectionFactory) {
